        ...
        <div className="pb-8 pt-12 xxl:px-72 xl:px-36 sm:px-6 lg:px-8 text-lg" data-aos="fade-up">
          ...
          <div className="text-gray-700 text-lg leading-relaxed space-y-4 text-justify">
            <p>
              ...
              (Sekaran). <br /><br />Kegiatan yang dilakukan di Rumah Pelita meliputi
              pembelajaran dan pengasuhan, kegiatan bermain dalam dan luar
              ruangan, pemberian waktu tidur, pemberian makan 2 kali, snack 1
              kali, dan susu 2 kali sehari, serta pemeriksaan kesehatan meliputi
              pemantauan asupan makan setiap hari, pengukuran antropometri
              setiap minggu, pemantuan perkembangan dan SDIDTK anak mingguan,
              dan pemeriksaan dokter puskesmas. Selain itu juga diadakan kelas
              parenting bagi ibu balita dan konseling kesehatan mental oleh
              psikolog. Melalui kegiatan-kegiatan tersebut diharapkan dapat
              membantu memperbaiki status gizi anak dan mempertahankan status
              gizi anak melalui pengasuhan yang tepat.
            </p>
          </div>
        </div>
      </section>
